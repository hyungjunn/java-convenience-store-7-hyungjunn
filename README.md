...
- [ ] 프로모션 할인을 적용한다.
- [ ] 프로모션 기간 중 프로모션 재고를 우선 차감하고, 프로모션 재고가 부족할 경우에는 일반 재고를 사용한다.
- [ ] 프로모션 적용이 가능한 상품인데 해당 수량보다 적게 구매했는지 판단한다.
- [ ] 증정 받을 수 있는 상품을 추가한다.
- [ ] 프로모션 혜택없이 결제해야 하는 수량을 계산한다.
- [ ] 주어진 수량을 정가로 결제한다.
- [ ] 정가로 결제해야하는 수량을 제외한 후 결제한다. 
- [ ] 프로모션 미적용 금액의 30% 멤버십 할인한다.
- [ ] 프로모션 적용 후 남은 금액에 멤버십 할인 받는다.
- [ ] 멤버십 할인은 8000원까지다.
- [ ] 총 구매액을 구한다.
